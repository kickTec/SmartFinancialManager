...
public class FundController {
    ...
    public String zipFundData(@RequestParam(value = "year", required = false) String year) {
        logger.debug("FundController.zipFundData in, param:{}", year);
        try {
            String storageHomePath = fileStorageService.getStorageHomePath();
            JarUtil.compressFundHistory(storageHomePath + File.separator + "history", Integer.parseInt(year));
